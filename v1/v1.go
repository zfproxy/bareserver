...
func Register(server *bare.BareServer) {
	...
	server.Handle("/v1/", func(request *bare.BareRequest, w http.ResponseWriter, options *bare.Options) (*bare.Response, error) {
	...
	server.Handle("/v1/ws-meta", func(request *bare.BareRequest, w http.ResponseWriter, options *bare.Options) (*bare.Response, error) {
	...
	server.Handle("/v1/ws-new-meta", func(request *bare.BareRequest, w http.ResponseWriter, options *bare.Options) (*bare.Response, error) {
	...
	server.HandleSocket("/v1/", func(request *bare.BareRequest, socket *websocket.Conn, options *bare.Options) error {
		defer socket.Close()
