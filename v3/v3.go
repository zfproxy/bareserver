...
func Register(server *bare.BareServer) {
	...
	server.Handle("/v3/", func(request *bare.BareRequest, w http.ResponseWriter, options *bare.Options) (*bare.Response, error) {
	...
	server.HandleSocket("/v3/", func(request *bare.BareRequest, clientConn *websocket.Conn, options *bare.Options) error {
